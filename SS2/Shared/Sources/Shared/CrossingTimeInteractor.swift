...
public protocol CrossingTimeInteractorProtocol {
...
public final class CrossingTimeInteractor: CrossingTimeInteractorProtocol {
    ...
    public func loadSavedTimeDiffs() -> (first: TimeDiff, second: TimeDiff) {
    ...
    public func saveTimeDiffs(first: TimeDiff, second: TimeDiff) {
    ...
    public func calculateValidCrossingTimes(firstDiff: TimeDiff, secondDiff: TimeDiff) -> (first: CrossingTime, second: CrossingTime) {
    ...
    public func updateFirstCrossing(to date: Date) -> (first: CrossingTime, second: CrossingTime) {
        let calendar = Calendar.current
        let now = Date()
        // Truncate to current minute by getting components
        let components = calendar.dateComponents([.year, .month, .day, .hour, .minute], from: now)
    ...
    public func updateSecondCrossing(to date: Date, relativeTo firstCrossing: CrossingTime) -> CrossingTime {
        let calendar = Calendar.current
